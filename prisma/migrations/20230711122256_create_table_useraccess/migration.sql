...
INSERT INTO "new_User" ("address", "cep", "city", "created_at", "email", "id", "name", "number", "password", "updated_at") SELECT "address", "cep", "city", "created_at", "email", "id", "name", "number", "password", "updated_at" FROM "User";
DROP TABLE "User";
